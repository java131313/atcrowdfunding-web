...
<html lang="zh-CN">
  ...
  <body>
    ...
    function dologin() {
          ...
          //验证表单元素
          var loginacct = $("#loginacct").get(0);
          var userpswd = $("#userpswd").get(0);;
          if ( loginacct.value == "" ){
        	  		layer.msg("登陆账号或密码不正确，请重新输入",{time:2000,icon:5,shift:6},function(){userpswd.focus();})
        	  		return;
          }
          if( userpswd.value == "" ){
        	 // console.log("没有填写密码");
