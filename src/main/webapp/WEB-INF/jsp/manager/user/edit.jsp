            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form id="userForm" role="form">
                  ...
                  <button type="button" class="btn btn-success" onclick="doUpdate()"><i class="glyphicon glyphicon-pencil"></i> 修改</button>
                  <button type="button" class="btn btn-danger" onclick="resetForm()"><i class="glyphicon glyphicon-refresh"></i> 重置</button>
                </form>
              </div>
            </div>
        </div>
    ...
    <script src="${APP_PATH}/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            function doUpdate() {
            	...
            	$.ajax({
            		type : "POST",
            		url  : "${APP_PATH}/manager/user/update",
            		data : {
            		...
            		success : function(result) {
            			...
            			if ( result.success ) {
            				layer.msg("用户信息修改成功", {time:1500, icon:6}, function(){
            					window.location.href = "${APP_PATH}/manager/user/index?pageno=${param.pageno}";
            				});
            			} else {
