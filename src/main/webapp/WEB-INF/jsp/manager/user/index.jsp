                ...
                <ul style="padding-left:0px;" class="list-group">
                    ...
                    <li class="list-group-item">
                        ...
                        <ul style="margin-top:10px;">
                            ...
                            <li style="height:30px;">
                                <a href="${APP_PATH}/manager/role/index"><i class="glyphicon glyphicon-king"></i> 角色维护</a> 
                            </li>
                            <li style="height:30px;">
                            <!-- user    /index --> 
                                <a href="${APP_PATH}/manager/permission//index2"><i class="glyphicon glyphicon-lock"></i> 许可维护</a> 
                            </li>
                        </ul>
                    </li>
                    <li class="list-group-item tree-closed">
...
<form class="form-inline" role="form" style="float:left;">
  <div class="form-group has-feedback">
    <div class="input-group">
      ...
      <!-- queryContext 3:返回html页面给用户 -->
      <input id="queryText" class="form-control has-success" type="text" placeholder="请输入查询条件">
    </div>
  </div>
  <button type="button" onclick="queryData()" class="btn btn-warning"><i class="glyphicon glyphicon-search"></i> 查询</button>
</form>
...
<button type="button" class="btn btn-primary" style="float:right;margin-left:10px;" onclick="window.location.href='${APP_PATH}/manager/user/add'"><i class="glyphicon glyphicon-plus"></i> 新增</button>
<button type="button" class="btn btn-primary" style="float:right;" onclick="window.location.href='${APP_PATH}/manager/user/addBatch'"><i class="glyphicon glyphicon-plus"></i> 批量新增</button>
<br>
 <hr style="clear:both;">
    ...
    <script src="${APP_PATH}/layer/layer.js"></script>
        <script type="text/javascript">
            $(function () {
                ...
                //进行分页查询
                //先查第一页
                //ajax线程。 ui线程  4：发送Ajax请求，查询数据
                console.log("user/index.jsp");
            	...
            	$.ajax({
            		...
            		success :  function(result) {
            		 ...
            		 $.each(users, function(index, user){
	                        ...
	                        content += '    <td>';
	                        content += '        <button type="button" onclick="window.location.href=\'${APP_PATH}/manager/user/assign?id='+user.id+'\'" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></button>';
	                        content += '        <button type="button" onclick="window.location.href=\'${APP_PATH}/manager/user/edit?pageno='+pageno+'&id='+user.id+'\'" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></button>';
