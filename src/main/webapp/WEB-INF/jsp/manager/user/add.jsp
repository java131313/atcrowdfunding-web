            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form role="form">
                  ...
                  <button type="button" class="btn btn-success" onclick="doInsert()"><i class="glyphicon glyphicon-plus"></i> 新增</button>
    ...
    <script src="${APP_PATH}/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            function doInsert() {
            	...
            	$.ajax({
            		type : "POST",
            		url  : "${APP_PATH}/manager/user/insert",
            		data : {
            		...
            		success : function(result) {
            			...
            			if ( result.success ) {
            				layer.msg("用户信息保存成功", {time:1500, icon:6}, function(){
            					window.location.href = "${APP_PATH}/manager/user/index";
            				});
            			} else {
