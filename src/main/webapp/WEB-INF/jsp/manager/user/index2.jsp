                    ...
                    <li class="list-group-item">
                        ...
                        <ul style="margin-top:10px;">
                            <li style="height:30px;">
                               <!--  1，点击菜单，跳转页面 -->
                                <a href="${APP_PATH}/manager/user/userPage" style="color:red;"><i class="glyphicon glyphicon-user"></i> 用户维护</a> 
                            </li>
                            <li style="height:30px;">
                     ...
                     <td colspan="6" align="center">
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" varStatus="status" end="${userPage.totalno}" >
                                <li ${userPage.pageno == status.count?"class='active'":""}><a href="javascript:;" onclick="changePageno(${status.count})">${status.count}</a></li>
                            </c:forEach>
    ...
    <script src="${APP_PATH}/script/docs.min.js"></script>
        <script type="text/javascript">
            ...
            function changePageno(no) {
            	window.location.href = "${APP_PATH}/manager/user/userPage?pageno="+no;
            }
        </script>
  </body>
</html>
